...
export default function App() {
    var _a = useDashboardSocket(), cars = _a.cars, metrics = _a.metrics, orders = _a.orders, connected = _a.connected, completeOrder = _a.completeOrder;
